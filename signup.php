...
<div class="signup-form">
    ...
    <h1 class="page-title">Sign up for a new acocunt</h1>
    ...
    <?php
        if(isset($_GET["error"])){
            ...
            if($_GET["error"]=="passwordLevel"){
                echo "<p>Password must contain at lease 8 characters, special, uppercase and lowercase letters.</p>";
            }
    ...
    ?>
        ...
        <div class="">
            <button type="submit" class="btn-submit" name="submit"><b>Sign Up</b></button>   
        </div>
    </form>
