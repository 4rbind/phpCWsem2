                ...
                <?php
                    while($row=$all_users->fetch_assoc()){
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="promote.php?userid=<?php echo $row["id"] ?>" class="edit" onClick="javascript:return confirm('Promoting the user. Confirm?')">Promote</a>
                                <a href="activate.php?userid=<?php echo $row["id"] ?>" class="deactivate" onClick="javascript:return confirm('Activating the user. Confirm?')">Activate</a>
