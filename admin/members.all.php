...
<div class="main-content">
    ...
    <a href="../signup.php" class="btn-table-top"><b>Add Member</b></a>
    <div class="data">
        <table>
            <thead>
                <tr>
            ...
            if ($row['profile_image']!=null){
                ?>
               <img src="../assets/uploads/<?php echo $row['profile_image']; ?>"  width="75"/>
               <?php
            }
            else{
                echo "<img src='../assets/images/default_user.png' width='75'  />";
            }
             ?></td>
